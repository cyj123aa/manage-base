...
public class UserController {
    ...
    public BackBO<Map<Long, List<SimpleDeptUserBO>>> getUserByDeptIds(@RequestBody List<Long> DeptIds){
        return BackBOUtil.defaultBackBO(userService.mapUserByDeptIds(DeptIds));
    }
}
